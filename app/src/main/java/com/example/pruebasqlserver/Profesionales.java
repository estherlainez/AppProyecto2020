...
public class Profesionales {
    ...
    public Profesionales(int idProfesional, String nombreProfesional, String emailProfesional, String telefonoProfesional, String passProfesional) {
    ...
    public Profesionales(String nombreProfesional, String emailProfesional, String telefonoProfesional) { ;
        this.nombreProfesional = nombreProfesional;
        this.emailProfesional = emailProfesional;
        this.telefonoProfesional = telefonoProfesional;
    }
